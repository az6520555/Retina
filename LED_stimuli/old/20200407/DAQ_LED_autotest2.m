clearvars -except rate volt lumin_filter offset stimu pw path filename 
...
mkdir(diode_path)
cd(diode_path)
filename=['diode_',ss,ddd];
i=0;
n=87;
while n~=0
    n=exist([filename,'_',num2str(i),'.mat'],'file')
    if n==0
        save([filename,'_',num2str(i),'.mat'],'callumin','callumin_filter','a2','ex','ey','eyf');
    end
    i=i+1;
end