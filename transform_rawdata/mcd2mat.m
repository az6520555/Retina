...
%%%%%%%%%%%%%%%%%%%%%% call all data in %%%%%%%%%%%%%%%%%%%%%%%%%% 
cd('\\192.168.0.102\Public\Retina\Chou\Exp\20220907') ; % the folder of the files
all_file = subdir('*.mcd') ;
...
%     [Spikes,TimeStamps,a_data,Infos] = analyze_MEA_data([directory,filename],1,'','Chou','all',100000); %filename,save_data,comment,experimenter,analog_type,r_interval
    [Spikes,TimeStamps,a_data,Infos] = analyze_MEA_data_revised([directory,filename],1,'','Chou','all',100000);
